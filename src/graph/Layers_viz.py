...
class GAT_viz(nn.Module):
    ...
    def forward(self, atom_list, bond_list, atom_degree_list, bond_degree_list, atom_mask):
        ...
        mol_feature = self.output(self.dropout(mol_feature))
            
        return atom_feature_viz, atom_attention_weight_viz, mol_feature_viz, mol_feature_unbounded_viz, mol_attention_weight_viz, mol_feature
